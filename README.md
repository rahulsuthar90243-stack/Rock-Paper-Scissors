...
This project demonstrates the use of functions, macros, random number generation, and clean project structure.
</p>

<hr>

<h2>Project Overview</h2>
<p>This is a simple yet well-structured <strong>Rock Paper Scissors</strong> game where:</p>

<ul>
      <li>The user plays against the computer</li>
        <li>Scores are tracked (User, Computer, Draws)</li>
        <li>Colored output is used for better terminal experience</li>
        <li>The project is built using modular programming principles</li>
    </ul>

<p>
    This project is suitable for <strong>C beginners</strong>, <strong>college projects</strong>, and <strong>GitHub portfolios</strong>.
    </p>

<h2>✨ Features</h2>
    <ul>
        <li> Interactive menu-driven program</li>
        <li> Random computer choice using <code>rand()</code></li>
        <li> Score tracking (User / Computer / Draws)</li>
        <li> Colored terminal output (ANSI escape codes)</li>
...
<h2>🧠 Concepts Used</h2>
    <ul>
        ...
        <li><code>rand()</code> and <code>srand()</code></li>
        <li>Macros (<code>#define</code>)</li>
